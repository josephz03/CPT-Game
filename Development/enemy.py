...
def starting_area():
    ...
    while game :
        ...
        displayScreen.fill(white)
        #right
        pygame.draw.rect(displayScreen, darkdarkgreen, (112, 90, 13, 10))
        pygame.draw.circle(displayScreen, darkgreen, (118, 70), 25)
        pygame.draw.rect(displayScreen, black, (128, 68, 4, 8)) 
        pygame.draw.rect(displayScreen, darkblue, (110, 100, 18, 40))
        pygame.draw.polygon(displayScreen, darkblue, ((128,100),(128,110),(154,120))) 
        pygame.draw.rect(displayScreen, black, (112, 140, 13, 30))

        #left
        pygame.draw.rect(displayScreen, darkdarkgreen, (212, 190, 13, 10))
        pygame.draw.circle(displayScreen, darkgreen, (218, 170), 25)
        pygame.draw.rect(displayScreen, black, (204, 168, 4, 8))
        pygame.draw.rect(displayScreen, darkblue, (210, 200, 18, 40))
        pygame.draw.polygon(displayScreen, darkblue, ((210,200),(210,210),(188,220)))
        pygame.draw.rect(displayScreen, black, (212, 240, 13, 30))
