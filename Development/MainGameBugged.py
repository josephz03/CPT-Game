...
def instructions():
    displayText(True, text_font('arial', 25, True, False), 'Instructions', black, 'Center', 849, 70)
    displayText(True, text_font('arial', 25, True, False), 'WASD = controls', black, 'Midleft', 620, 100)
    displayText(True, text_font('arial', 25, True, False), 'Space = attack/use item', black, 'Midleft', 620, 120)
    displayText(True, text_font('arial', 25, True, False), 'Shift = sprint', black, 'Midleft', 620, 140)
    displayText(True, text_font('arial', 25, True, False), 'Inventory = 1-5', black, 'Midleft', 620, 160)
    displayText(True, text_font('arial', 25, True, False), 'Enter = talk', black, 'Midleft', 620, 180)
    displayText(True, text_font('arial', 25, True, False), 'Goal', black, 'Center', 849, 220)
    displayText(True, text_font('arial', 25, True, False), '-Kill as many enemies as possible and earn', black, 'Midleft', 620, 265)
    displayText(True, text_font('arial', 25, True, False), 'rewards!', black, 'Midleft', 627, 284)
    displayText(True, text_font('arial', 25, True, False), '-Killing enemies will drop materials and', black, 'Midleft', 620, 312)
    displayText(True, text_font('arial', 25, True, False), 'use materials to upgrade yourself!', black, 'Midleft', 627, 334)
    displayText(True, text_font('arial', 25, True, False), '-The more you explore, the more you will find', black, 'Midleft', 620, 362)
    displayText(True, text_font('arial', 25, True, False), 'upgrades and side quest!', black, 'Midleft', 627, 384)
    displayText(True, text_font('arial', 25, True, False), '-To win the game, you will need to kill the boss', black, 'Midleft', 620, 412)
    displayText(True, text_font('arial', 25, True, False), 'and all the enemies will leave the world :)', black, 'Midleft', 627, 434)
