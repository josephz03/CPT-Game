...
def starting_area():
    ...
    while game :
        ...
        displayScreen.fill(white)
        #right
        pygame.draw.rect(displayScreen, darkdarkgreen, (112, 90, 23, 20))
        pygame.draw.circle(displayScreen, red, (118, 70), 35)
        pygame.draw.rect(displayScreen, black, (135, 60, 10, 10)) 
        pygame.draw.rect(displayScreen, darkblue, (110, 100, 28, 50))
        pygame.draw.polygon(displayScreen, darkblue, ((128,100),(128,110),(164,120))) 
        pygame.draw.rect(displayScreen, black, (112, 140, 23, 30))

        #left
        pygame.draw.rect(displayScreen, darkdarkgreen, (212, 190, 23, 20))
        pygame.draw.circle(displayScreen, red, (218, 170), 35)
        pygame.draw.rect(displayScreen, black, (190, 160, 10, 10))
        pygame.draw.rect(displayScreen, darkblue, (210, 200, 28, 50))
        pygame.draw.polygon(displayScreen, darkblue, ((210,200),(210,210),(178,220)))
        pygame.draw.rect(displayScreen, black, (212, 240, 23, 40))
