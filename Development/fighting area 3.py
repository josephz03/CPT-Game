...
def starting_area():
    ...
    while game :
        ...
        pygame.draw.rect(displayScreen, grey, (500, 200, 200, 640))
        pygame.draw.rect(displayScreen, grey, (0, 200, 500, 200))
        pygame.draw.polygon(displayScreen, cardboard_brown,[(870,100), (850,160), (1100,260), (1120,200)])
        pygame.draw.polygon(displayScreen, cardboard_brown,[(70,50), (50,100), (300,100), (320,50)])
        tree(1000,450)
